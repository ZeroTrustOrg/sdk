export enum PASSKEY_ERRORS {
	...
	INVALID_GET_CREDENTIAL_RESPONSE = "The provided response is not a valid response object from a get call",
	INVALID_CREATE_CREDENTIAL_RESPONSE = "The provided response is not a valid response object from a create call",
